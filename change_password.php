			...
			<form action="" method="post" enctype="multipart/form-data">
				<table class="table table-bordered table-hover">
						...
						<tr>
							...
							<td>
								<input type="password" name="u_pass2" id="mypass" class="form-control" required placeholder="Cofirm Password"/>
							</td>
						</tr>
						<tr align="center">
							<td colspan="6">
			...
			<?php
			   ...
			   if(isset($_POST['change']))
			   {
			     ...
			     if($pass1 != $pass2)
			     {
			     	echo"
			     	<div class='alert alert-danger'>
			     		<strong>Your New Password didn't match with the confirmed one!</strong>
			     	</div>
			     ...
			     if($pass1 == $pass2 AND $c_pass == $user_password)
			     {
			     	...
			     	echo"
			     	<div class='alert alert-danger'>
			     		<strong>your Password has been sucessfully changed</strong>
			     	</div>
