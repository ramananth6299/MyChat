				...
				<form action="" method="post" enctype="multipart/form-data">
					<table class="table table-bordered table-hover">
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id ="f">
												<strong>HINT......</strong>
												<textarea class="form-control" cols="83" rows="4" name="content" placeholder="HINT"></textarea><br>
												<input class="btn btn-default" type="submit" name="sub" value="Submit" style="width: 100px;"><br><br>
												<pre>This is in case u have forgotten your<br> Password.</pre>
												<br><br>
											</form>
											<?php
											...
											if (isset($_POST['sub'])) {
												...
												{
													$update = "UPDATE users SET forgotten_password='$bfn' WHERE user_email='$user'";
						...
						<tr>
							<td></td>
								<td>
									<a  class="btn btn-default" style="text-decoration: none;font-size: 15px;" href="change_password.php"><i class="fa fa-key fa-fw" aria-hidden="true"></i>Change Password</td>
						</tr>
