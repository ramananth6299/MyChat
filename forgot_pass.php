...
<body>
	<div class="signin-form">
		<form action="" method="post">
			...
			<div class="form-group">
				<label>Hint</label>
				<input type="text" class="form-control" name="bf" placeholder="HINT...." autocomplete="off" required>
			</div>
			<div class="form-group">
				<button type="submit" class="btn btn-primary  btn-block btn-lg" name="submit">Submit</button>
			</div>
		</form>
		<div class="text-centre small" style="color: white;">Back to Signin? <a href="signin.php">Click here</a></div>
	...
	if(isset($_POST['submit']))
	{
		...
		$select_user= "select * from users where user_email='$email' AND forgotten_password='$recovery_account'";
		...
		{
			echo"<script>alert('Your email or hint is incorrect!')</script>";
